...
function intro(){
  ...
  //Add a new text node to the bodyDiv to make a description of the quiz appear on the screen. 
  ...
  //Activity 2.2 - Append the textNode to the bodyDiv element.
...
function buildQuiz(){
  ...
  for(var i = 0; i < questions.length; i++){
    //Activity 5 - Create a variable called questionDiv and create a new h3 element that will be used for the question text.
  ...
  //Activity 10.1 - Create a variable called submitButton and create a new button element. 
...
function displayResult(){
  ...
  //Activity 14.1 - Create a new variable called headerDiv and create a new div element.
